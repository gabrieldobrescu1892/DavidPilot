...
const t={en:{k:"FOUNDER & CEO",title:"Engineering leadership for the age of AI.",lead:"Gabriel Dobrescu founded DavidPilot to bring enterprise engineering discipline to AI implementation.",body:["With more than a decade of experience across software engineering, cloud infrastructure, DevOps, platform engineering and engineering management, Gabriel has built and led technology environments where security, reliability and scale are non-negotiable.","DavidPilot was created around a simple belief: AI should not be another disconnected experiment. It should be engineered into the way a business operates—securely, responsibly and with a clear economic purpose."],exp:"Experience",roles:["Engineering leadership","Enterprise platforms","Cloud & DevOps","AI automation architecture"],ph:"Technology is only valuable when it produces results."},ro:{k:"FONDATOR & CEO",title:"Leadership în inginerie pentru era AI.",lead:"Gabriel Dobrescu a fondat DavidPilot pentru a aduce disciplina ingineriei enterprise în implementarea AI.",body:["Cu peste un deceniu de experiență în software, infrastructură cloud, DevOps, platform engineering și management tehnic, Gabriel a construit și coordonat medii în care securitatea, fiabilitatea și scalarea sunt esențiale.","DavidPilot a fost creat pornind de la o convingere simplă: AI-ul nu trebuie să fie încă un experiment izolat. Trebuie integrat în modul de funcționare al unei companii—securizat, responsabil și cu un scop economic clar."],exp:"Experiență",roles:["Leadership în inginerie","Platforme enterprise","Cloud & DevOps","Arhitectură de automatizare AI"],ph:"Tehnologia are valoare doar atunci când produce rezultate."}};
export default function About(){return <PageFrame>{({lang})=>{const c=t[lang];return <><section className="page-hero container"><span className="eyebrow">{c.k}</span><h1>{c.title}</h1><p>{c.lead}</p></section><section className="container executive-grid"><figure className="founder-portrait-card">
