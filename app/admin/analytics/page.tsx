...
export default function AnalyticsPage(){
  ...
  return <main className="analytics-shell">
    <nav className="admin-nav"><Link href="/admin">Lead Cockpit</Link><Link className="active" href="/admin/analytics">Analytics</Link><Link href="/admin/copy-studio">AI Copy Studio</Link><Link href="/admin/proposals">Proposals</Link><Link href="/admin/clients">Clients</Link><Link href="/admin/onboarding">Onboarding</Link></nav>
